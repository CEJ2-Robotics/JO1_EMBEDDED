/**
 * @file nRF24.h
 * @brief Hardware abstraction layer for nRF24L01 module communication
 * @details Provides the necessary functions for interacting with the
 *          nRF24L01+ RF transceiver using SPI communication
 *          It allows setup, transmission, reception, configuration of various parameters (like
 *          power level, data rate, CRC length, etc.), and provides debug functions
 *          to print out relevant configurations and statuses
 */
...
void nrf24_setup_routine(SPI_HandleTypeDef *hspi, UART_HandleTypeDef *huart);
vehicle_coordinates_t nrf24_read_gps(void);
