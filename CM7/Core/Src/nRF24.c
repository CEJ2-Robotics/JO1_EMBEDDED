/**
 * @file nRF24.c
 * @brief Implementation of HAL for nRF24L01 module communication
 */
...
/** @brief SPI handle for the nRF24L01 module communication */

static SPI_HandleTypeDef nrf24_hspi;

/** @brief UART handle for debugging nRF24L01 module */
...
{
    uint8_t buffer[6];
    vehicle_coordinates_t coordinates = {0, 0, 0};
